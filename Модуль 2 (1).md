...
<img width="713" height="59" alt="image" src="https://github.com/user-attachments/assets/7bc52dff-280f-4e67-b935-52f874b0798a" />
...
<img width="404" height="28" alt="image" src="https://github.com/user-attachments/assets/f18b0686-fad3-4b2f-8083-f1ad041c46df" />
...
<img width="471" height="69" alt="image" src="https://github.com/user-attachments/assets/22322fb3-ce6e-4036-b527-55c5cbed3bce" />
...
<img width="723" height="53" alt="image" src="https://github.com/user-attachments/assets/906906bc-9a60-4263-9c05-bb9febbc61e7" />
...
<img width="494" height="23" alt="image" src="https://github.com/user-attachments/assets/b10e8dcc-ea00-4b34-9f6c-e1225c883764" />
...
ansible all -m ping
```
<img width="1337" height="697" alt="image" src="https://github.com/user-attachments/assets/facd5657-0f67-46f3-8fe5-5ff9bf139488" />
...
services:
  ...
  app:
    ...
    environment:
      ...
      - DB_TYPE=mariadb
```
<img width="975" height="655" alt="image" src="https://github.com/user-attachments/assets/e233cca1-1b9f-4095-b824-ef0f4c57de11" />
...
```
CREATE DATABASE weblc;
CREATE USER 'web'@'localhost' IDENTIFIED BY 'P@ssw0rd';
GRANT ALL PRIVILEGES ON weblc.* TO 'web'@'localhost';
FLUSH PRIVILEGES;
EXIT;
```
